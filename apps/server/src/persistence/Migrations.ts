...
import Migration0031 from "./Migrations/031_ProjectionThreadResumeSessionId.ts";
import Migration0032 from "./Migrations/032_Automations.ts";
import Migration0033 from "./Migrations/033_KanbanBoard.ts";
...
export const migrationEntries = [
  ...
  [31, "ProjectionThreadResumeSessionId", Migration0031],
  [32, "Automations", Migration0032],
  [33, "KanbanBoard", Migration0033],
] as const;
